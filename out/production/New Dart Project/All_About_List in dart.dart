...
// // //   String? wahter = ' sunny ';
// // //   if(isweekend && wahter == ' sunny '){
// // //     print(" Let's go the park! Boy Hahaha ");
// // //   }else{
//     print(" O NO its not a sunny boy lets go Home ");
//   }
// }
// // // this is a set in dart
// // // main(){
// // //   var ratigs = { 1,2, 3};
// // //   print(ratigs);
// // //   print(ratigs.iterator);
// // //   print('lengths ${ratigs.length}');
// // }
// void main(){
//   var S= {2,3454,5};
//   print(S.elementAt(0));
...
// // }
// // void main(){
// //   var ratings = ['Ferdah 1, ', " hossan ",  ];
// //   for( var ratings in ratings){
// //     print(ratings);
// //   }
// // }
// // // void main(){
